...
class TextChannelHost extends BotDriver_1.default {
    get name() {
    ...
    getRecentChannelMessages() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield BotDriver_1.default.prototype.getRecentChannelMessages.call(this, this.guild, this.channel);
        });
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.client.on('messageCreate', (message) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    const t0 = Date.now();
                    const responses = (0, split_text_to_chunks_1.default)(yield (0, gpt_1.askWithCurva)('gpt4_t03_5k', `${this.prompt}\n\n${context}`, ''), 1800);
