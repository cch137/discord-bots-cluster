...
function googleSearchSummary(query) {
    return __awaiter(this, void 0, void 0, function* () {
        return (yield axios_1.default.get(`https://${constants_1.API_ORIGIN}/google-search-summary?showUrl=true&query=${query}`)).data;
    });
}
function ddgSearchSummary(query) {
    return __awaiter(this, void 0, void 0, function* () {
        return (yield axios_1.default.get(`https://${constants_1.API_ORIGIN}/ddg-search-summary?showUrl=true&query=${query}`)).data;
    });
}
let client = null;
...
function connect() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield client.login(process.env.CH4_TOKEN);
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            ...
            function logStatus() {
                var _a, _b, _c;
                return __awaiter(this, void 0, void 0, function* () {
                    const result = (yield axios_1.default.get('https://ch4.us.to/api/status')).data;
                    ...
                    targetMessage.edit({
                        ...
                        embeds: [
                            new discord_js_1.EmbedBuilder().setFields(...[
                                ...
                                { name: 'Database:', value: [`Total Messages: ${result.totalMessages}`, `Registered Users: ${result.totalRegisteredUsers}`, `Data Size: ${(0, formatBytes_1.default)(result.dataSize)}`].join('\n') },
                            ].filter(f => f.name))
                        ]
                    });
                });
        ...
        client.on('messageCreate', (message) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (content.at(0) === '_') {
                ...
                switch (command) {
                    ...
                    case '_google':
                        if (args.length) {
                            replyWithCodeBlocks(message, yield googleSearchSummary(args.join(' ')));
                        }
                        break;
                    case '_ddg':
                    case '_duckduckgo':
                        if (args.length) {
                            replyWithCodeBlocks(message, yield ddgSearchSummary(args.join(' ')));
                        }
                        break;
                    case '_rand':
                    case '_random':
