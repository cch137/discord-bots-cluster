...
exports.replaceMessagesUserPingToUsername = exports.createMappedUidUsername = exports.extractUids = void 0;
const uidRegex = /<@(\d+)>/g;
...
function createMappedUidUsername(guild, messages, usingNickname = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        messages.forEach(m => extractUids(m.content).forEach((uid) => userIdList.add(uid)));
...
function replaceMessagesUserPingToUsername(messages, mappedUidUsername) {
    messages.forEach((message) => {
        extractUids(message.content).forEach((uid) => {
